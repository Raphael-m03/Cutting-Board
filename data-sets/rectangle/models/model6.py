...
lr_scheduler = tf.keras.callbacks.LearningRateScheduler(lambda epoch: 0.005 * ((0.955*(epoch < 25)) + (0.98*(epoch >= 25))) ** epoch)
...
# Save the model
model.save("tenRect6.h5")
model.save("tenRect6.keras")
